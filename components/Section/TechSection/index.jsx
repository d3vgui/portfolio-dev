...
export default function TechSection() {
    ...
    let ctx = gsap.context(() => {
      ...
      const animateNextCard = () => {
        ...
        tl.to(cardToAnimate, {
          ...
          scale: 1,
          boxShadow: "#00000066 0px 2px 4px, #0000004d 0px 7px 13px -3px, #00000033 0px -3px 0px inset",
          zIndex: 1,
  ...
  return (
    <section id="techSection" className={`${styles.configSection} ${styles.techSection}`} ref={containerRef}>
      <div className={`${"container d-flex flex-wrap"} ${styles.content}`}>
        <div className={`${"col-lg-6 col-md-12 col-12"} ${styles.contentTech}`}>
          <CardTech
            text="JavaScript"
            src={javascriptIcon}
            alt="JavaScript Logo"
        ...
        <div className="col-lg-5 col-md-12 col-12">
          <div className={`${styles.title} d-flex align-items-center justify-content-center gap-5`}>
            <h2><span>02. </span>TECNOLOGIAS</h2>
            <div className={styles.line}></div>
          </div>
          <div className={styles.text}>
            <span>Desenvolvimento Front-end & UI</span>
            <p>
              Crio interfaces modernas, responsivas e focadas na experiência do usuário, transformando protótipos em código funcional.
            </p>
            <span>Dados & Business Intelligence</span>
            <p>Minha bagagem analítica me permite estruturar dados complexos e criar visualizações estratégicas para tomada de decisão.</p>
